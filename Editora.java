...
public class Editora implements Subject {
	...
	public void iniciar() {
		...
		while((!this.observersEstadao.isEmpty() || !this.observersEstadaoDiario.isEmpty() || !this.observersMarie.isEmpty()) ) {
			...
			exemplar1.setExemplar("Jornal Estadao aos finais de semana");
			exemplar2.setExemplar("Revista Marie Claire Semanal");
			exemplar3.setExemplar("Jornal Estadao Diário");
